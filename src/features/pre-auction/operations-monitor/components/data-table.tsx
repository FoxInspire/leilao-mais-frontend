...
export interface TableOperationMonitorDetailsHandle {
   resetSelection: () => void
}

export const TableOperationMonitorDetails = React.forwardRef<
   TableOperationMonitorDetailsHandle,
...
TableOperationMonitorDetails.displayName = 'TableOperationMonitorDetails'
